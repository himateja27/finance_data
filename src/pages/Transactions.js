...
const Transactions = () => {
  ...
  const getCategoriesForType = (recordType) => {
    return recordType === "income" ? incomeCategories : expenseCategories;
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-pink-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl shadow-purple-900/20 overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 px-6 py-8 sm:px-10 sm:py-10">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-purple-100/80 text-sm sm:text-base">
                    View and manage all your income and expense transactions in
                    one place.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-slate-600 bg-slate-800/50 px-4 py-3 text-white placeholder-slate-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                    >
                  ...
                  <table className="w-full text-sm text-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-700">
                      {records.length > 0 ? (
                        ...
                        <tr>
                          <td
                            colSpan={hasPermission("manage_records") ? 6 : 5}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <select
                  ...
                  required
                  className="w-full rounded-xl border border-slate-600 bg-slate-700/50 px-4 py-3 text-white focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                >
                  <option value="income">Income</option>
                  <option value="expense">Expense</option>
                </select>
              ...
              <div>
                ...
                <input
                  ...
                  min="0"
                  required
                  className="w-full rounded-xl border border-slate-600 bg-slate-700/50 px-4 py-3 text-white placeholder-slate-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                  placeholder="0.00"
                />
              </div>
              ...
              <div>
                ...
                >
                  ...
                  {getCategoriesForType(formData.record_type).map((cat) => (
                    <option key={cat.value} value={cat.value}>
                      {cat.label}
                    </option>
                  ))}
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="flex-1 rounded-xl bg-purple-600 px-4 py-3 text-white font-semibold hover:bg-purple-700 transition"
                >
