...
const Expense = () => {
  ...
  const fetchRecords = useCallback(async () => {
    try {
      setLoading(true);
      const params = { record_type: "expense" };
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-pink-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl shadow-purple-900/20 overflow-hidden">
            <div className="bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 px-6 py-8 sm:px-10 sm:py-10">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  <p className="text-sm uppercase tracking-[0.28em] text-red-100/90">
                    Expense Management
                  </p>
                  <h1 className="mt-3 text-4xl font-semibold text-white">
                    Expense Records
                  </h1>
                  <p className="mt-3 max-w-2xl text-red-100/80 text-sm sm:text-base">
                    Track and manage all your expense transactions with detailed
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-slate-600 bg-slate-800/50 px-4 py-3 text-white placeholder-slate-400 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20"
                    >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  min="0"
                  required
                  className="w-full rounded-xl border border-slate-600 bg-slate-700/50 px-4 py-3 text-white placeholder-slate-400 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20"
                  placeholder="0.00"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleFormChange}
                  required
                  className="w-full rounded-xl border border-slate-600 bg-slate-700/50 px-4 py-3 text-white focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20"
                >
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="flex-1 rounded-xl bg-red-600 px-4 py-3 text-white font-semibold hover:bg-red-700 transition"
                >
